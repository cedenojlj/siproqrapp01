            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        @auth
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('dashboard.index') }}"><span class="pe-1"><svg
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('products.index') }}"><span class="pe-1"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('customers.index') }}"><span class="pe-1"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                            fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                                            <path
                                                d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z" />
                                        </svg></span>{{ __('Customers') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('warehouses.index') }}"><span class="pe-1"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                            fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
                                            <path
                                                d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z" />
                                        </svg></span>{{ __('Warehouses') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('petitions.index') }}"><span class="pe-1"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                        ...
                                        </svg></span>{{ __('Petitions') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('orders.index') }}"><span class="pe-1">
                                        ...
                                        </svg></span>{{ __('Orders') }}</a>
                            </li>

                            {{-- nav-item prices.index --}}
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('prices.index') }}"><span class="pe-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                        ...
                                        </svg></span>{{ __('Prices') }}</a>
                            </li>

                            <li class="nav-item dropdown">
                                <a id="reportsDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    <span class="pe-1"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                                            height="25" fill="currentColor" class="bi bi-file-earmark-bar-graph"
                                            viewBox="0 0 16 16">
                                            <path
                                ...
                                <div class="dropdown-menu" aria-labelledby="reportsDropdown">
                                    <a class="dropdown-item"
                                        href="{{ route('reports.inventory-by-warehouse') }}">{{ __('Inventory by Warehouse') }}</a>
                                    <a class="dropdown-item"
                                        href="{{ route('reports.historical-movements') }}">{{ __('Historical Movements') }}</a>
                                </div>
                            </li>
                        @endauth
                    </ul>
