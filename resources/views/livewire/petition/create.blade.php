<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">{{ __('Create New Petition') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form wire:submit.prevent="savePetition">
                        <div class="mb-3">
                        ...
                        @foreach ($products as $index => $productItem)
                            <div class="row mb-3 align-items-end">
                                <div class="col-9 col-md-5">
                                    ...
                                    <select
                                        class="form-select @error('products.' . $index . '.product_id') is-invalid @enderror"
                                        id="product-{{ $index }}"
                                ...
                                <div class="col-10 col-md-2">
                                    ...
                                    <input type="text" class="form-control" id="price-{{ $index }}"
                                        wire:model="products.{{ $index }}.price" readonly>
                                </div>
                                <div class="col-1 col-md-1">
                                    <button type="button" class="btn btn-danger"
                                        wire:click="removeProduct({{ $index }})"><svg
                        ...
                        <div class="mb-3">
                            <button type="button" class="btn btn-secondary" wire:click="addProduct">Add Another
                                Product</button>
                        </div>
        ...
        <div><livewire:petition.modal-listado /></div>
    </div>
